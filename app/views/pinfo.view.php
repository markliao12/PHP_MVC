        ...
        <section id="main" style="color:black;min-height: 85vh">
            ...
            <div class="row">
                <div class="col-sm-12 text-center">
                    <a class="btn btn-outline-primary" aria-current="page" href="<?= ROOT ?>/historyinfo">Back</a>
                </div>
            </div>
            <hr />
            <div class="table-responsive">
                <table class="table table-hover dt-responsive display table-bordered nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <tr>
                            <td><?=$data['info'][0]->u_fname." ".$data['info'][0]->u_lname?></td>
                            <td><?=$_SESSION['p_view']['u_date']?></td>
                            <td><?=$data['info'][0]->reg_hrs?></td>
                            <td><?=$data['info'][0]->bonus_hrs?></td>
                            <td><?=$data['info'][0]->tot_hrs?></td>
                            <td><?=$data['info'][0]->reg_pay?></td>
                            <td><?=$data['info'][0]->bonus_pay?></td>
                            <td><?=$data['info'][0]->tot_pay?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
