    ...
    <div id="wrapper">
        ...
        <section id="main" style="min-height: 80vh">
            ...
            <form class="form-signin" method="post">
                ...
                <input type="text" name="w_address" id="address" value="<?= $data['location']->w_address ?>" class="form-control" placeholder="Address" required autofocus><br>
                ...
                <select name="w_status" id="sta-select" class="form-control" required>
                    ...
                    <?php foreach ($data['staus'] as $dts) {
                        if ($dts->ws_id == $data['location']->w_status) {
                            echo "<option selected value=" . $dts->ws_id . ">" . $dts->ws_name . "</option>";
                        } else {
