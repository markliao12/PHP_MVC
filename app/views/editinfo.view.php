                ...
                <table class="table table-hover dt-responsive display table-bordered nowrap" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?=$_SESSION['edit_info']['d_date']?></td>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <input type="text" placeholder="Choose Date" name="start_dt" value="<?=$data['r_time']?>" class="form-control" id="first_dt" autocomplete="off" required>
